...
foreach cls $savedirectories {
    pack [button .palette.save$cls  -text $cls -bg gray -borderwidth 0 -command "File::SavePDF /Users/sahill/www/class/$cls/Repository" -padx 0 -pady 0] -side left -anchor n -fill y 
}
